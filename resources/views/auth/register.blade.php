                    ...
                    <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>من فضلك اعد ادخال الاسم</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>من فضلك اعد ادخال البريد الالكتروني</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input  type="number" class="form-control @error('email') is-invalid @enderror" name="phone">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>من فضلك اعد ادخال كلمة لسر</strong>
                                    </span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">اعد ادخال كلمة السر</label>
